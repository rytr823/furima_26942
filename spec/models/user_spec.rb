...
describe User do
  describe '#create' do
    ...
    it 'is invalid without a password_confirmation although with a password' do
      ...
      user.valid?
      expect(user.errors[:password_confirmation]).to include("とパスワードの入力が一致しません", "は半角英数字混合で入力してください。")
    end
    ...
    it 'is invalid without a last_name' do
      ...
      user.valid?
      expect(user.errors[:last_name]).to include("を入力してください", "は全角で入力して下さい。")
    end
    ...
    it 'is invalid without a family_name_katakana' do
      ...
      user.valid?
      expect(user.errors[:family_name_katakana]).to include("を入力してください", "はカタカナで入力して下さい。")
    end
    ...
    it 'is invalid without a last_name_katakana' do
      ...
      user.valid?
      expect(user.errors[:last_name_katakana]).to include("を入力してください", "はカタカナで入力して下さい。")
    end
